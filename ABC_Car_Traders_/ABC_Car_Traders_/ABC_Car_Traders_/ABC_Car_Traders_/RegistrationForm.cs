...
namespace ABC_Car_Traders_
{
    public partial class RegistrationForm : Form
    {
        ...
        private void btn_reg_Click(object sender, EventArgs e)
        {
            ...
            {
                string sqlinsert;
                sqlinsert = "insert into customer (Name, Email, Nic, Address, Password, conpassword, Telp) values ('" + txt_name.Text + "','" + txt_em.Text + "','" + txt_nic.Text + "','" + txt_add.Text + "','" + txt_pw.Text + "','" + txt_pwconfirm.Text + "','" + txt_tp.Text + "')"; 
